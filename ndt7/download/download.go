...
func Do(ctx context.Context, conn *websocket.Conn, data *model.ArchivalData, MaxScaledMessageSize int64, AveragePoissonSamplingInterval int64) error {
	...
	err := sender.Start(ctx, conn, data, MaxScaledMessageSize, AveragePoissonSamplingInterval)
